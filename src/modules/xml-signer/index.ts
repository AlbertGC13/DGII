...
export { isVerifiedSignedXmlArtifact, serializeAuthenticatedXml, serializeVerifiedSignedXml, verifyDgiiXmlSignature } from "./infrastructure/xml-dsig-verifier.js";
